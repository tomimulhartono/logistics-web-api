                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown text-white font-weight-bold">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item  text-dark font-weight-bold" href="data_purchase_order.php">Data Purchase Order</a>
                            <div class="dropdown-divider"></div>
...
<?php
$url = "https://salesapi.000webhostapp.com/sales/api/datatransaksi.php";
